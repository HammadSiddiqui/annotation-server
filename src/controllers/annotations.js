...
exports.create = async function(request, response) {
    try {
        ...
        let newAnnotation = await annotation.save()
        //updating the annotation object with the ID generated by mongo:
        let finalAnnotation = await AnnotationModel.findOneAndUpdate({_id : newAnnotation._id}, {$set : {'content.id' : newAnnotation.id}}, {returnOriginal: false})
